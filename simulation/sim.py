...
from race_monitor.kayn_controller.kayn_controller.supervisor.fsm import FSM
from race_monitor.kayn_controller.simulation.track import mixed_track
...
if __name__ == '__main__':
    ...
    data = run_simulation()
    from race_monitor.kayn_controller.simulation.plot import plot_results
    plot_results(data)
    print("Done. Plots in simulation/results/")
